...
import { z } from 'zod';
import { ChevronLeft, Store, Phone, MapPin, Clock, Globe, Camera, FileText, ArrowRight, UploadCloud } from 'lucide-react';
      ...
      <div className="sticky top-0 z-30 backdrop-blur-md bg-white/70 border-b border-white/50 shadow-sm supports-[backdrop-filter]:bg-white/60">
        <div className="max-w-4xl mx-auto px-4 py-4 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <h1 className="font-bold text-xl text-gray-900">새 가게 등록</h1>
          </div>
          <div className="text-sm text-gray-500 font-medium">
            <span className="text-orange-600">Partner</span> Center
          </div>
        </div>
      </div>
